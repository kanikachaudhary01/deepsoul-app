...
function Features() {
    return (
        <>
            <div className="pt-50 pb-10 md:py-0">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10 md:gap-12 px-6 sm:px-12 md:px-20 pt-16 pb-10">
                    <FeatureBox
                        icon={<Calendar />}
